...
export default async function AboutPage() {
    try {
        const response = await fetch(
            `https://api.harvardartmuseums.org/object?apikey=${process.env.HARVARD_API_KEY}&size=9&permissionlevel:0 AND title:* AND period:* AND medium:*&fields=title,primaryimageurl,medium,period,objectnumber`
        );
